...
import { Booking } from 'apps/booking-service/src/app/domain/booking-entity';
import { DiningTable } from 'apps/booking-service/src/app/domain/dining-table.entity';
import { Restaurant } from 'apps/booking-service/src/app/domain/restaraunt.entity';
import { OutboxMessage } from 'persistence';

import type { DataSourceOptions } from 'typeorm';

export const reservationServiceTypeOrmOptions: DataSourceOptions = {
  type: 'postgres',
  ...(process.env.PG_URL
    ? {
